...
export default function Page() {
  ...
  const sections = [
    ...
    },
    {
      ...
      description:
        "Milestone Project Management integrates advanced tools and scientific methods to deliver accurate, actionable insights:",
      image:
  ...
  return (
    <main className="bg-white text-gray-900">
        ...
        <div className="container grid grid-cols-1 place-items-center lg:grid-cols-2 gap-10">
          <div className="space-y-3">
            ...
            <p>
              ...
              full range of environmental services that help public and private
              sector clients manage growth responsibly while protecting natural
              resources. From regulatory compliance to sustainability advisory,
              our solutions are designed to reduce risks, ensure environmental
              safety, and support long-term resilience.
      ...
      <section className="relative isolate overflow-hidden bg-gradient-to-b from-white to-slate-50 py-20">
        <div className="container ">
          <h2 className="text-4xl lg:text-5xl text-center max-w-3xl mx-auto font-bold tracking-tight text-slate-900">
            Why Choose Milestone Project Management for Environmental Services?
          </h2>
      ...
      <EngineeringCTA
        ...
        desc="Whether it’s conducting impact studies, implementing air quality monitoring systems, or launching digital waste management tools, Milestone Project Management is committed to building a greener future. Our work helps clients make informed decisions, reduce environmental risks, and meet the growing demand for sustainable development."
